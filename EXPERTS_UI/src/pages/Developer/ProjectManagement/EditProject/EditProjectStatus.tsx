...
import { NewProjectsIcon, OffPlanProjectsIcon, TickIcon } from "../../../../components/CustomFile/icons";
import { developerService, type AmenityMasterItem } from "../../../../services/developerService";
...
const EditProjectStatus = ({ projectId, project, onContinue, primaryActionLabel = "Save changes" }: EditProjectStatusProps) => {
        ...
        developerService
            ...
            .then((data) => {
                const amenities = (data.amenities || [])
                    ...
                    .map((item: AmenityMasterItem) => ({ id: item._id, name: item.name }));
    ...
    const onSave = async () => {
        setIsSaving(true);
        try {
            await developerService.updateProject(projectId, {
