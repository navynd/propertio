...
import { ChangeIcon, DownloadIcon, LeftArrowIcon, PdfIcon, PlusIcon, RightArrowIcon, TrashIcon } from "../../../../components/CustomFile/icons";
import Loader from "../../../../components/Loader/loader";
import { API_BASE_URL } from "../../../../services/apiClient";
import { developerService, type SupportedUrlsMasterData } from "../../../../services/developerService";
...
const EditMedia = ({
    ...
    const uploadMediaFiles = async (files: { images?: File[]; video?: File; brochure?: File; masterPlan?: File }) => {
        ...
        await developerService.uploadProjectMedia(formData);
    };
    ...
    const onSave = async () => {
        ...
        try {
            ...
            await developerService.updateProject(projectId, { virtualTour360: tourLink.trim() || null });
