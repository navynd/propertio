...
function ProjectDescription({ project }: { project: any }) {
    ...
    const detailRows = [
        ...
        },
        {
            ...
            value: <span className="font-[Bold]">{project?.projectStatus}</span>,
        },
        {
        ...
        },
        {
            ...
            value: (
                <span className="font-[Bold]">
                    {project?.governmentFees != null && project?.governmentFees !== ""
                        ? `${project.governmentFees}%`
                        : "--"}
                </span>
            ),
        },
        {
            label: "Zone location",
            value: <span className="font-[Bold]">{project?.projectLocation?.zone || "--"}</span>,
        },
        {
            ...
            value: (
                <span className="font-[Bold]">
                    ...
                    project?.propertyPrice?.startingFrom !== ""
                        ? `${project?.propertyPrice?.currency ?? ""} ${project.propertyPrice.startingFrom}`.trim()
                        : "--"}
                </span>
            ),
        },
