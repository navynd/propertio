...
import { agencyService, type ListingType } from "../../../../../services/agencyService";
...
const PropertyTypeStep = ({
    ...
    const [propertyTypeOptions, setPropertyTypeOptions] = useState<
        Array<{ _id: string; name: string; slug?: string; isActive?: boolean; displayOrder?: number }>
    >([]);
    ...
    useEffect(() => {
        let mounted = true;
        setLoading(true);
        Promise.all([agencyService.getListingTypesMasterData(), agencyService.getPropertyTypesMasterData()])
