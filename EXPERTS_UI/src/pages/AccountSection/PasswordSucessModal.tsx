...
const PasswordSucessModal: React.FC<PasswordSucessModalProps> = ({
    isOpen,
    onClose,
    autoCloseMs = 1800,
}) => {
    ...
    // Auto-close to return user to login screen
    // (keeps UX consistent with text "Redirecting to the login page...")
    useEffect(() => {
