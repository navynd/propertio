    ...
    return (
        <>
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                        {agencies.map((agency) => (
                            ...
                            >
                                <img
                                    src={agency.img || home1img}
                                    alt=""
                                    className="h-[80px] w-[80px] shrink-0 rounded-[10px] object-cover"
                                />
                                <span className="text-[15px] font-[SemiBold] text-[#222] leading-[165%] truncate">{agency.name}</span>
                            </div>
                        ))}
                    </div>
                </section>
            ...
            <div className="rounded-[15px] bg-white  min-w-0">
                <div className="flex items-center justify-between gap-4 md:p-[25px_30px_20px_30px] p-[20px]">
            ...
            {/* Masterplan / Video (always show; hide only 360) */}
            <div className="flex flex-col gap-5 sm:gap-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 min-w-0">
                    <section className="rounded-[15px] bg-white md:p-[30px] p-[20px] min-w-0 flex flex-col">
                        <h2 className="text-[20px] font-[Bold] text-[#222] mb-[20px] leading-[100%]">Masterplan</h2>
            ...
            <div className="rounded-[15px] bg-white p-5 md:p-[30px] p-[20px] min-w-0">
                <h2 className="text-[20px] font-[Bold] text-[#222] mb-[15px]">About the project</h2>
                <div className="flex flex-col gap-4 text-[14px] font-[Regular] text-[#222] leading-[165%]">
                    <RichTextContent content={project?.aboutProject} />
                </div>
            </div>
            {/* Frequently asked questions */}
            <div className="rounded-[15px] bg-white md:p-[30px] p-[20px] min-w-0">
                <h2 className="text-[20px] font-[Bold] text-[#222] mb-[15px]">Frequently asked questions</h2>
                {faqItems.length === 0 ? (
