...
const StatusChangeModal = ({ isOpen, onClose, nextStatus, onSave, unitOptions }: StatusChangeModalProps) => {
    const [unit, setUnit] = useState("");
    const [isUnitDropdownOpen, setIsUnitDropdownOpen] = useState(false);
    const unitDropdownRef = useRef<HTMLDivElement>(null);
    const [showConfirm, setShowConfirm] = useState(false);

    const resolvedUnitOptions = unitOptions && unitOptions.length > 0 ? unitOptions : ["Unit 1", "Unit 2", "Unit 3"];
                        ...
                        <div className="flex flex-col gap-[24px] mt-[35px]">
                            ...
                            <div ref={unitDropdownRef} className="relative">
                                ...
                                >
                                    ...
                                    <DownArrowIcon width={11} height={7} className={`transition-transform ${isUnitDropdownOpen ? "rotate-180" : ""}`} />
                                </button>
                                {isUnitDropdownOpen && (
                ...
                >
                    ...
                    <div className="flex-1 p-[0px_20px_20px_20px] md:p-[0px_50px_50px_50px] overflow-visible">
                        ...
                        <p className="text-center text-[14px] font-[Regular] text-[#222] mt-[10px]">
                            This In-progress status will be kept for 10 days
                        </p>
