...
const footerLinkColumns = [
  {
    title: "Properties",
    links: [
      { label: "Buy properties", path: "/searchlisting" },
      { label: "Rent properties", path: "/searchlisting" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Mortgage calculator", path: "/mortgagecal" },
      { label: "Property blog", path: "/blog" },
      { label: "About Estatehub", path: "/about" },
    ],
  },
  {
    title: "Top Destinations",
    links: [
      { label: "Dubai luxury residences", path: "/searchlisting?destination=Dubai" },
      { label: "London prime properties", path: "/searchlisting?destination=London" },
      { label: "New York penthouses", path: "/searchlisting?destination=New%20York" },
      { label: "Paris apartments", path: "/searchlisting?destination=Paris" },
      { label: "Miami waterfront homes", path: "/searchlisting?destination=Miami" },
    ],
  },
  {
    title: "Support & Legal",
      ...
      <PFContainer className="pf-footer__inner">
        ...
        <Box className="pf-footer__download">
          <Typography className="pf-footer__downloadText">
            Download our Estatehub app on Playstore and Appstore
          </Typography>
        ...
        <Box className="pf-footer__bottom">
          <Typography className="pf-footer__copyright">
            Copyright © {new Date().getFullYear()} Estatehub. All rights
            reserved.
          </Typography>
          <div
