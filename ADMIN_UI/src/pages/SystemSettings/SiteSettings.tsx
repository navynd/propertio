...
function SiteSettings() {
  ...
  const [appName, setAppName] = useState("Estatehub");
  const [siteTitle, setSiteTitle] = useState("Estatehub - Real Estate Platform");
  ...
  useEffect(() => {
    ...
    const fetchSettings = async () => {
      try {
        ...
        if (active) {
          setAppName(data.appName || "Estatehub");
          setSiteTitle(data.siteTitle || "Estatehub - Real Estate Platform");
